function genHTMLHvrBtn(iconId) {
    return `
        <button id="${iconId}Hvr"
                class="display-none"
                w3-include-hvr-btn="./assets/img/svgHTML/6-leftArrowHover.html">
        </button>
...
function genHTMLFormAddTask(float = '', footnoteFloat = '', formPanelFloat = '', state = 'display-none', anim) {
    ...
    <form id="formAddTask" class="form-add ${float} ${anim}">
        <div class="form-btn-back btn-back-addTask ${state}">
            <button id="btnBack5Hvr" type="button" class="display-none" 
